    ...
    return (
      <Layout style={{ padding: "1rem", textAlign: "center" }}>
        <Content style={contentStyle}>
          ...
          <Title level={3} style={{ padding: "1rem", textAlign: "left" }}>
            Features
          </Title>
            ...
            <Col xs={24} sm={24} md={8} lg={8} xl={8} style={colStyle}>
              <Link to="/coins">
                ...
                >
                  <h2>Coin Listing</h2>
                  <p>
                    This site aims to be mobile friendly. View website on any
                    device you like.
                  </p>
                </Card>
              </Link>
            ...
            <Col xs={24} sm={24} md={8} lg={8} xl={8} style={colStyle}>
              <Link to="/exchanges/list">
                ...
                >
                  ...
                  <p>
                    Exchange lists provides the exchange rates of various
                    exchange platforms.
                  </p>
                </Card>
              </Link>
            ...
            <Col xs={24} sm={24} md={8} lg={8} xl={8} style={colStyle}>
              <Link to="/exchange-rates">
                ...
                >
                  ...
                  <p>
                    Exchange Rates Listing provides the user with the current
                    cryptocurrency value in terms of bitcoin.
                  </p>
                </Card>
              </Link>
            </Col>
